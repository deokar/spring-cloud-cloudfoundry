...
public class CloudFoundryDiscoveryClient implements DiscoveryClient {
    ...
    /**
     * Any client willing to downcast can get extra metadata about the {@link ServiceInstance}
     * from the {@link #getCloudApplication()} and {@link #getInstanceInfo()} accessor methods.
     */
